...
/* HTML */
'<div class="mobile-header"> <div class="mh-closing-x iconfont clickable" id="close-mobile-plugin">}</div> </div> <div class="plugin-content"> <h2>Flymet</h2> <ul style="padding-left: 20px;"> <li><a data-flymet="">nic</a></li> <li><a data-flymet="cudf" style="font-weight: bold;">Deficit konvektivní teploty</a></li> <li><a data-flymet="cukh">Kupovitá oblačnost</a></li> <li><a data-flymet="cuvr">Rychlost stoupání</a></li> <li><a data-flymet="curyb">Stoupání 1500 m</a></li> <li><a data-flymet="drtr">Druh termiky</a></li> </ul> <p>Neprůhlednost: <input id="flymet-opacity" type="range" min="0" max="100" value="50" style="vertical-align: text-bottom;"></p> <p>Zdroj dat: <a href="https://flymet.meteopress.cz/cr/" target="_blank">Flymet</a></p> </div>',
/* CSS */
